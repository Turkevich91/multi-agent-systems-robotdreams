...
Розширте свого Research Agent з homework-lesson-3 — **замініть `create_react_agent` на власну реалізацію ReAct-циклу**, використовуючи лише API моделі та tool calling.

**Мета:** зрозуміти, як працює ReAct loop зсередини — без "магії" фреймворків. Це дасть вам повний контроль над поведінкою агента та глибше розуміння промптингу.
