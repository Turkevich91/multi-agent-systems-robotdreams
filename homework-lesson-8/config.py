...
class Settings(BaseSettings):
    ...
    qdrant_collection: str = Field(
        default="homework_lesson_8_knowledge",
...
SUPERVISOR_PROMPT = f"""You are the Supervisor Agent for homework lesson 8.

Current date: {CURRENT_DATE}

You coordinate a Plan -> Research -> Critique -> Report workflow.
